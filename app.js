...
var deviceJson = fs.readFileSync(path.join(__dirname, "device.json")).toString();
console.log(deviceJson);
var device = JSON.parse(deviceJson);

// Read device connection string from command line arguments and parse it
var connectionStringParam = device.connectionString; //process.argv[2];
